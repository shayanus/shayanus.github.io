				...
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							Built real-time apps and data systems that streamline student course registration and campus scheduling, improving efficiency and user experience.
						</p>
						<p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							Computer Science Graduate, <span className="text-red-400">Rutgers University</span>
						</p>
					</div>
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-6 md:mb-8">
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-white-400 text-xs md:text-sm">SQL</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-white-400 text-xs md:text-sm">Python</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-white-400 text-xs md:text-sm">AWS</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-white-400 text-xs md:text-sm">Snowflake</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-white-400 text-xs md:text-sm">React & Next.js</span>
					</div>
				</motion.div>
