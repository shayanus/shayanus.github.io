						...
						<div className="p-8">
							<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
								<div className="space-y-6">
									<div>
										<h3 className="text-2xl font-bold mb-4">Machine Learning Content Sorter</h3>
										<p className="text-gray-400">
											Developed an automated file sorting system using Python and AWS services, categorizing files into predefined folders based on their names and contents. Integrated AWS SageMaker for machine learning-based classification of file content, enhancing sorting accuracy and efficiency. 
										</p>
									</div>
